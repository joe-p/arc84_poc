...
import { DeclarationRegistryClient, DeclarationRegistryFactory } from '../contracts/clients/DeclarationRegistryClient';

const fixture = algorandFixture();
Config.configure({ populateAppCallResources: true });

let appClient: DeclarationRegistryClient;

describe('DeclarationRegistry', () => {
  ...
  beforeAll(async () => {
    ...
    const factory = new DeclarationRegistryFactory({
      algorand,
